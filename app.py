"""
庫存調貨建議系統 v2.21.0 - Streamlit應用程序
...
with tab_system:
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            current_run_key = f"{mode_code}_{b_special_receive_site_limit_option}_{f2_allow_hd_transfer}_{d2_enable_2site_limit}_{uploaded_file.name}_{uploaded_file.size}"
