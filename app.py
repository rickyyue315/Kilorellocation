...
<div style="display: flex; align-items: center; gap: 20px; margin: 8px 0 28px 0; padding-bottom: 18px; border-bottom: 1px solid rgba(255,255,255,0.06);">
    ...
    <div>
        <h1 style="margin: 0 !important; font-size: 7.6rem !important; font-weight: 900; color: #FFFFFF !important; -webkit-text-fill-color: #FFFFFF !important; line-height: 1.1; letter-spacing: -0.5px; text-shadow: 0 0 40px rgba(6, 182, 212, 0.25);">庫存調貨建議系統</h1>
