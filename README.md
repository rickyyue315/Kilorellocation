...
| B2 | 附加 B 特別模式 | Type=L 低銷量可全轉出，接收上限 Safety × 2 |
| B2a | 附加 B2a | 參照 B2，且 Type=T 不可作為來源 |
| B3 | 附加 B 跨 OM 特別模式 | 參照 B2，允許跨 OM，含 HD/Windy 限制 |
| B3a | 附加 B3a 跨 OM 特別模式 | 參照 B3，且 Type=T 不可作為來源 |
