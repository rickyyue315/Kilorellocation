...
| C1 | 重點補 0（只補 0/1） | 參照 C，但接收端只處理總可用庫存 0 或 1 的店舖 |
...
1. 上傳 Excel。
2. 選擇模式。
3. 若為 B2/B2a/B3/B3a/E1/E1b/E2/ND1/ND2，可設定接收店數限制。
4. 點擊「生成調貨建議」。
5. 檢視表格與統計。
6. 下載 Excel 報表。
...
- 在側欄選擇 B2/B2a/B3/B3a/E1/E1b/E2/ND1/ND2 後，會出現「出貨店舖接收店數限制」。
